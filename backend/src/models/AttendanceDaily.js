...
const AttendanceDailySchema = new mongoose.Schema({
    ...
    status: {
        type: String,
        enum: ['PENDING', 'WORKING', 'ON_BREAK', 'COMPLETED', 'REJECTED', 'MISSING_CLOCK_OUT', 'PRESENT', 'LATE', 'HALF_DAY', 'ABSENT', 'PAID_LEAVE', 'LEAVE', 'HOLIDAY', 'WEEK_OFF', 'EARLY_LEAVE', 'OVERTIME', 'REQUIRES_REVIEW', 'PENDING_CHECK_IN_APPROVAL', 'PENDING_BREAK_APPROVAL', 'PENDING_CHECK_OUT_APPROVAL'],
        default: 'PENDING',
        index: true
    },
